...
const Field = React.forwardRef(({label, type, ph, style}, ref) => {
  return (
    <div>
      ...
      <input ref={ref} type={type} placeholder={ph} class={style} required="" />
    </div>
  );
});
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <input type="hidden" name="remember" defaultValue="true" />
                  <div>
                    ...
                    <Field 
                    ref={mailRef} ph="Brukernavn" type="text" style="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />  

                  
                  </div> 
                  <div>
                  <Field
                  ref={passwordRef}  ph="••••••••" type="password" style="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />  
                  </div>
